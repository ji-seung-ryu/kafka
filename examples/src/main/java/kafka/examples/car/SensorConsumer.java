...
public class SensorConsumer {
    ...
    private static final String GROUP_ID = "sensor_group";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("[Sensor Consumer] Waiting for sensor data...");
        ...
        while (true) {
            ...
            for (ConsumerRecord<String, String> record : records) {
                ...
                if (lastTimestampMap.containsKey(vehicleId) && lastTimestampMap.get(vehicleId) > timestamp) {
                    ...
                    System.out.println("✅ [Sensor Consumer] Processing Time: " + processingTime + "ms\n");
